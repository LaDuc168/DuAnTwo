...
public class BaoCaoXuatAdapter extends BaseAdapter {
    Context myContext;
    ArrayList<BaoCaoXuatInstance> mangXuat;

    public BaoCaoXuatAdapter(Context myContext, ArrayList<BaoCaoXuatInstance> mangNhap) {
        this.myContext = myContext;
        this.mangXuat = mangNhap;
    }

    @Override
    public int getCount() {
        return mangXuat.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view=inflater.inflate(R.layout.dong_item_bao_cao_xuat,null);
        ...
        BaoCaoXuatInstance n=mangXuat.get(i);
